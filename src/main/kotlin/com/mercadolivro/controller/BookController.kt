...
class BookController(
    ...
    @GetMapping("/canceled")
    fun findCanceled(@PageableDefault(page = 0, size = 10) pageable: Pageable): PageResponse<BookResponse> {
        return bookService.findCanceled(pageable).map { it.toResponse() }.toPageResponse()
    }
